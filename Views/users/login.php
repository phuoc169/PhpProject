                    ...
                    <div class="col-md-6">
                        <div class="well">
                            <div class="return-customer">
                                ...
                                <form method="POST">
                                <input type="hidden" name="NumberPhone" placeholder="Enter your email address..." id="input-email" class="form-control">
                                <input type="hidden" name="FirstName" placeholder="Enter your email address..." id="input-email" class="form-control">
                                <input type="hidden" name="LastName" placeholder="Enter your email address..." id="input-email" class="form-control">
                                    ...
                                    <input type="submit" name="btnlogin" value="Login" class="return-customer-btn">
                                </form>
                            </div>
                        </div>
                    </div>
